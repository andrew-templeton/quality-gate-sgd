 ...
 */
export const COVERAGE_ONLY_DEFAULTS: QualityRules = {
 ...
 */
export const FULL_DEFAULTS: QualityRules = {
  version: '0.0.0-embedded',
 ...
 */
export function getDefaultRules(coverageOnly: boolean): QualityRules {
 ...
 */
export function isEmbeddedDefaults(rules: QualityRules): boolean {

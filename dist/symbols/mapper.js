 ...
 */
export function mapLocationToSymbol(table, file, line, column) {
 ...
 */
function findContainingSymbol(symbols, line, column) {
    // Find all symbols that contain this line
    const candidates = symbols.filter(sym => line >= sym.span.startLine && line <= sym.span.endLine);
 ...
 */
function findMatchingFile(table, targetPath) {
 ...
 */
export function mapLocationsToSymbols(table, locations) {
 ...
 */
export function getFileSymbols(table, file) {
 ...
 */
export function getSymbolById(table, id) {

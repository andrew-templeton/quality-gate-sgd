...
export const EVIDENCE_CONTEXT = freezeJson({
...
export function assertionContext(assertion) {
...
export function catalogContext(modules) {
...
export function evaluationCostUpperBound(assertions) {
...
export function compositionContext(gate) {

 ...
 */
export function registerDimension(def) {
 ...
 */
export function clearCustomDimensions() {
    customDimensions.length = 0;
}
/**
 * Get a dimension definition by path.
 */
export function getDimension(path) {
 ...
 */
export function getSmoothDimensions() {
    return getDimensionsByContinuity('smooth');
}
/**
 * Get dimensions best used as hard constraints (discrete/binary).
 */
export function getConstraintDimensions() {
    return getAllDimensions().filter((d) => d.continuity === 'discrete' || d.continuity === 'binary');
}
/**
 * Format dimensions as a table string for CLI/documentation.
 */
export function formatDimensionsTable(dimensions) {
 ...
 */
export function generateDimensionsDoc() {

 ...
 */
export function createConditions(design, options = {}) {
    const baseConfig = {
        seed: options.seed,
 ...
 */
export function getBaselineCondition(design) {
 ...
 */
export function getTreatmentConditions(design) {
    const conditions = createConditions(design);
 ...
 */
function createDesignAConditions(base) {
    return [
        {
            name: 'no-gate',
            design: 'A',
 ...
 */
function createDesignBConditions(base) {
    return [
        {
            name: 'coverage-only',
            design: 'B',
 ...
 */
function createDesignCConditions(base) {
    return [
        {
            name: 'default',
            design: 'C',
 ...
 */
function createDesignDConditions(base) {
    return [
        {
            name: 'unweighted',
            design: 'D',
 ...
 */
function createDesignEConditions(base) {
    return [
        {
            name: 'default',
            design: 'E',
 ...
 */
function createDesignFConditions(base) {
    return [
        {
            name: 'raw',
            design: 'F',
 ...
 */
export function canPairConditions(condition1, condition2) {

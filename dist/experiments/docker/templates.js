 ...
 */
export function generateAgentConfig(agentType, overrides) {
...
export function generateExperimentDefinition(options) {
    const { id, name, description, design, agentType, taskSource, taskId, gatePort = 3000, } = options;
 ...
 */
export function generateConditionConfigs(design) {
    const conditions = createConditions(design);
 ...
 */
export function generateExperimentReadme(definition) {
 ...
 */
function getConditionDescriptions(design) {
    const descriptions = {

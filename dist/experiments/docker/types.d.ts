 ...
 */
export type RunState = 'pending' | 'initializing' | 'running' | 'evaluating' | 'completed' | 'failed' | 'cancelled';
/**
 ...
 */
export type TrajectoryEventType = 'run_started' | 'run_ended' | 'gate_query' | 'suggestion_request' | 'suggestion_received' | 'metrics_extracted' | 'evaluation_completed' | 'file_modified' | 'test_run' | 'error';
/**

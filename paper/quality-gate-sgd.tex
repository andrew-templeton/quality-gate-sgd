...
Let $\mathcal{T} = \{t_1, t_2, \ldots, t_m\}$ be the set of enumerable optimization targets, where each target is a tuple:
\[
t = (\text{file}, \text{symbol}?, \text{line\_range}?, \text{issue\_cluster})
\]
\end{definition}
